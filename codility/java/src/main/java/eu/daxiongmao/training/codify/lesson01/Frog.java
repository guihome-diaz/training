...
public class Frog {
	...
	/**
	 * Even though this solution is good and working it is 0.1% too slow compare to the modulo version.
	 *
	 * @param startPoint
	 *            start point
	 * @param endPoint
	 *            final point. It must be more than start point otherwise nothing will happen (returns 0)
	 * @param jumpSize
	 *            jump size. it must be > 0
