...
public class FrogCross {
   ...
   * </p>
   * <p>
   * This version deals with HUMAN logic. That means it <strong>based on 1...X</strong> <br/>
   * From a computer perspective this will create an array int[riverSize + 1] with index[O] not
   * used.
   * </p>
   *
